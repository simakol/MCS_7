...
/*
* Визначення this у стрілок

* 1. this визначається на момент створення

* 2. Після визначення контесту - його змінити неможливо. НІЯК.

* 3. Контекстом стрілочної функції буде контекст батьківської функції (він його наслідує і запамʼятовує)
*/
...
const user = {
  ...
  changeAge(newAge) {
    const foo = () => console.log("THIS of changeAge (inside arrow fn):", this);
    foo();
